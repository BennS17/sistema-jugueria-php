...
// 2. Verificamos si el usuario es un CAJERO que ha iniciado sesión
...
<head>
    <meta charset="UTF-8">
    <title>Panel del Cajero - Juguería Fiori</title>
    ...
    <div class="container">
        <nav class="sidebar">
            ...
            <div class="sidebar-nav">
                <a href="cajero_inicio.php" class="active">🏠 Inicio</a>
                <a href="cajero_pedidos.php?vista=verificar">🚦 Verificar Pedidos</a>
                <a href="cajero_pedidos.php?vista=cobrar">💰 Generar Cobro</a>
                </div>
        ...
        <main class="main-content">
            <h1>Panel de Control del Cajero</h1>
            <p>Selecciona una opción de la barra lateral para gestionar los pedidos.</p>
        </main>
    </div>
</body>
</html>